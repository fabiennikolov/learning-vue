...
export default defineConfig({
  shortcuts: [
    ...
    { 'home-link': 'transition-all-500 hover:scale-105 text-6 uppercase bg-white display-inline-block p-1 my-2 rounded-3 b-black b-2 hover:bg-slate-3 text-center b-transparent rounded-4 drop-shadow-md' },
